...
public class CheciEntity<T> implements Serializable {
    ...
    private Integer id;
    @TableField(value = "yideng")
    private Float yideng;
    @TableField(value = "erdeng")
    private Float erdeng;
    ...
    @TableField(value = "dongwo")
    private Float dongwo;

    @TableField(value = "shangwu")
    private Float shangwu;

    @TableField(value = "yingzuo")
    private Float yingzuo;

    @TableField(value = "ruanzuo")
    private Float ruanzuo;

    @TableField(value = "yingwo")
    private Float yingwo;

    @TableField(value = "ruanwo")
    private Float ruanwo;

    public Float getDongwo() {
        return dongwo;
    }

    public void setDongwo(Float dongwo) {
        this.dongwo = dongwo;
    }

    public Float getShangwu() {
        return shangwu;
    }

    public void setShangwu(Float shangwu) {
        this.shangwu = shangwu;
    }

    public Float getYingzuo() {
        return yingzuo;
    }

    public void setYingzuo(Float yingzuo) {
        this.yingzuo = yingzuo;
    }

    public Float getRuanzuo() {
        return ruanzuo;
    }

    public void setRuanzuo(Float ruanzuo) {
        this.ruanzuo = ruanzuo;
    }

    public Float getYingwo() {
        return yingwo;
    }

    public void setYingwo(Float yingwo) {
        this.yingwo = yingwo;
    }

    public Float getRuanwo() {
        return ruanwo;
    }

    public void setRuanwo(Float ruanwo) {
        this.ruanwo = ruanwo;
    }
    ...
    public Float getYideng() {
        return yideng;
    }

    public void setYideng(Float yideng) {
        this.yideng = yideng;
    }

    public Float getErdeng() {
        return erdeng;
    }

    public void setErdeng(Float erdeng) {
        this.erdeng = erdeng;
    }
