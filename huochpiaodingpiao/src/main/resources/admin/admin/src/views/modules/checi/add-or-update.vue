    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="一等座" prop="yideng">
                       <el-input v-model="ruleForm.yideng"
                                 placeholder="一等座" clearable  :readonly="ro.yideng"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="一等座" prop="yideng">
                           <el-input v-model="ruleForm.yideng"
                                     placeholder="一等座" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="二等座" prop="erdeng">
                       <el-input v-model="ruleForm.erdeng"
                                 placeholder="二等座" clearable  :readonly="ro.erdeng"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="二等座" prop="erdeng">
                           <el-input v-model="ruleForm.erdeng"
                                     placeholder="二等座" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>

               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="商务座" prop="shangwu">
                       <el-input v-model="ruleForm.shangwu"
                                 placeholder="商务座" clearable  :readonly="ro.shangwu"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="商务座" prop="shangwu">
                           <el-input v-model="ruleForm.shangwu"
                                     placeholder="商务座" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>

               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="动卧" prop="dongwo">
                       <el-input v-model="ruleForm.dongwo"
                                 placeholder="动卧" clearable  :readonly="ro.dongwo"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="动卧" prop="dongwo">
                           <el-input v-model="ruleForm.dongwo"
                                     placeholder="动卧" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>

               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="硬座" prop="yingzuo">
                       <el-input v-model="ruleForm.yingzuo"
                                 placeholder="硬座" clearable  :readonly="ro.yingzuo"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="硬座" prop="yingzuo">
                           <el-input v-model="ruleForm.yingzuo"
                                     placeholder="硬座" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>

               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="软座" prop="ruanzuo">
                       <el-input v-model="ruleForm.ruanzuo"
                                 placeholder="软座" clearable  :readonly="ro.ruanzuo"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="软座" prop="ruanzuo">
                           <el-input v-model="ruleForm.ruanzuo"
                                     placeholder="软座" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>

               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="硬卧" prop="yingwo">
                       <el-input v-model="ruleForm.yingwo"
                                 placeholder="硬卧" clearable  :readonly="ro.yingwo"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="硬卧" prop="yingwo">
                           <el-input v-model="ruleForm.yingwo"
                                     placeholder="硬卧" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>

               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="软卧" prop="ruanwo">
                       <el-input v-model="ruleForm.ruanwo"
                                 placeholder="软卧" clearable  :readonly="ro.ruanwo"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="软卧" prop="ruanwo">
                           <el-input v-model="ruleForm.ruanwo"
                                     placeholder="软卧" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
            ...
            return {
                ...
                rules: {
                   checiName: [
                        ...
                        //   yideng: [
                        //       { required: true, message: '一等座价格不能为空', trigger: 'blur' },
                        //   ],
                        //   erdeng: [
                        //       { required: true, message: '二等座价格不能为空', trigger: 'blur' },
                        //   ],
                   checiPhoto: [
