...
import center from '@/views/center'
    ...
    import zhekou from '@/views/modules/zhekou/list'
    import yunyingbaogao from '@/views/modules/yunying/list'
...
const routes = [{
    ...
    children: [{
      ...
      path: '/yunying',
      name: '运营报告',
      component: yunyingbaogao,
      meta: {icon:'', title:'yunyingbaogao'}
    },{
      path: '/pay',
      name: '支付',
      component: pay,
