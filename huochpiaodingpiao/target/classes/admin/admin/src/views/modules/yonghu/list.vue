<template>
    <div class="main-content">
            ...
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt"
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '会员姓名' : ''">
                        <el-input prefix-icon="el-icon-search" v-model="searchForm.yonghuName" placeholder="会员姓名"
                            clearable></el-input>
                    </el-form-item>
                ...
                <el-row class="ad"
                    ...
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                            ...
                            href="http://localhost:8080/huochpiaodingpiao/upload/yonghuMuBan.xls">批量导入会员数据模板</a>
                        &nbsp;
                        <el-upload v-if="isAuth('yonghu', '导入导出')" style="display: inline-block"
                            action="huochpiaodingpiao/file/upload" :on-success="yonghuUploadSuccess"
                            :on-error="yonghuUploadError" :show-file-list=false>
                            <el-button v-if="isAuth('yonghu', '导入导出')" type="success"
                                icon="el-icon-upload2">批量导入会员数据</el-button>
                        </el-upload>
                        &nbsp;
                        <!-- 导出excel -->
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="yonghuName"
                        header-align="center" label="会员姓名">
                        <template slot-scope="scope">
                    ...
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="zhengjian"
                        header-align="center" width="200" label="证件图片">
                        <template slot-scope="scope">
                            <div v-if="scope.row.zhengjian">
                                <img :src="scope.row.zhengjian" width="100" height="100">
                            </div>
                            <div v-else>无图片</div>
                        </template>
                    </el-table-column>
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="yonghuPhone"
                        header-align="center" label="会员手机号">
                        <template slot-scope="scope">
                    ...
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign"
                        prop="yonghuIdNumber" header-align="center" label="会员身份证号">
                        <template slot-scope="scope">
                    ...
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="zhekouValue"
                        header-align="center" label="折扣">
                        <template slot-scope="scope">
                            {{ scope.row.zhekouValue }}
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column width="300" :align="contents.tableAlign" header-align="center" label="操作">
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('yonghu', '修改')" type="success" icon="el-icon-edit" size="mini"
                                @click="openDialog(scope.row.id)">票价折扣</el-button>
        ...
        <el-dialog title="请选择折扣选项" :visible.sync="dialogVisible" @close="handleClose">
                <el-form :model="forma">
                    <el-form-item label="折扣选项">
                        <el-select v-model="forma.zhekou" placeholder="请选择折扣">
                            <el-option v-for="option in discountOptions" :key="option.id" :label="option.piaozhong"
    ...
    methods: {
        ...
        fetchDiscountOptions() {
            this.$http({
                ...
                this.discountOptions = data.data;
            });
        },
        submitDiscount() {
            if (this.forma.zhekou) {
                this.$http({
                    url: "yonghu/bangding",
                    method: "post",
                    data: {
                        id:this.forma.id,
                        zhekou: this.forma.zhekou
                    }
                }).then(({ data }) => {
                    this.getDataList();
                ...
                this.$message.warning('请选择一个折扣选项');
            }
        },
        handleClose() {
